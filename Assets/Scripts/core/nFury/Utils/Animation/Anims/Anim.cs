...
namespace nFury.Utils.Animation.Anims
{
  public class Anim
  {
    ...
    public uint DelayTimer { get; set; }
    ...
    public Action<Anim> OnCompleteCallback { get; set; }

    public Action<Anim> OnBeginCallback { get; set; }
    ...
    public virtual Easing.EasingDelegate EaseFunction { get; set; }
